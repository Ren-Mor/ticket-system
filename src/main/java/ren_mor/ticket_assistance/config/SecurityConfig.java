package ren_mor.ticket_assistance.config;
...
//                        .requestMatchers("/users/**").authenticated() // Serve token JWT valido
//                        .requestMatchers("/tickets/**").authenticated() // Serve token JWT valido
